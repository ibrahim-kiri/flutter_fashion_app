...
import 'package:fashion/src/notifications/widgets/notifications_shimmer.dart';
import 'package:fashion/src/profile/hooks/fetch_order.dart';
import 'package:fashion/src/profile/widget/order_tile.dart';
                    ...
                    TableRow(
                      ...
                      children: [
                        ...
                        Padding(
                          padding: EdgeInsets.all(8.h),
                          child: Text(
                            order.createdAt.add(const Duration(days: 3)).toString().substring(0,10),
                            style: appStyle(12, Kolors.kDark, FontWeight.normal),
                          ),
                        ),
                      ],
